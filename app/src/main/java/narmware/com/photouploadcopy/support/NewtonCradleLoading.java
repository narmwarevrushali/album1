...
public class NewtonCradleLoading extends LinearLayout {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.cradle_ball, this, true);
    }

    @Override
    protected void onFinishInflate() {
        super.onFinishInflate();
        cradleBallOne = (CradleBall) findViewById(com.victor.loading.R.id.ball_one);
        cradleBallTwo = (CradleBall) findViewById(com.victor.loading.R.id.ball_two);
        cradleBallThree = (CradleBall) findViewById(com.victor.loading.R.id.ball_three);
        cradleBallFour = (CradleBall) findViewById(com.victor.loading.R.id.ball_four);
        cradleBallFive = (CradleBall) findViewById(com.victor.loading.R.id.ball_five);
