...
JSONParser mJsonParser;
    ...
    public void showMobileDialog() {
        mEmptyMobileDialog = new Dialog(getContext());
        mEmptyMobileDialog.getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT);
        mEmptyMobileDialog.setContentView(R.layout.dialog_profile_mobile);
        mEmptyMobileDialog.setCancelable(false);
        mEmptyMobileDialog.show();

        final EditText mEdtprof=mEmptyMobileDialog.findViewById(R.id.edt_prof);
        if(mMobile!=null)
        {
            mEdtprof.setText(mMobile);
        }
        Button cancel = mEmptyMobileDialog.findViewById(R.id.btn_cancel);
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mEmptyMobileDialog.dismiss();
            }
        });

        Button mBtnSubmit=mEmptyMobileDialog.findViewById(R.id.btn_submit);
        mBtnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                 mMobile=mEdtprof.getText().toString();
    ...
    class SendAddress extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try
            {
                ...
                address.setUser_id(SharedPreferencesHelper.getUserId(getContext()));
        ...
        protected void onPostExecute(String s) {
            ...
            try{Gson gson = new Gson();
                ...
                if(response==Constants.PROFILE_RESPONSE)
                {
                    ...
                    DatabaseAccess databaseAccess = DatabaseAccess.getInstance(getContext());
                    databaseAccess.open();
                    databaseAccess.UpdateUserAddress(mAddress, SharedPreferencesHelper.getUserId(getContext()));
                    showMobileDialog();
                }
                mProgress.dismiss();
            }catch (Exception e)
    ...
    class SendMobile extends AsyncTask<String, String, String> {
        protected ProgressDialog mProgress;
        ...
        protected void onPreExecute() {
            ...
            mProgress.setProgressStyle(ProgressDialog.STYLE_SPINNER);
            mProgress.setIndeterminate(true);
            mProgress.setMessage("Updating Mobile number");
            mProgress.setCancelable(false);
            mProgress.show();
    ...
    class UpdateFrndProfile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try
            {
                ...
                friends.setUser_id(SharedPreferencesHelper.getUserId(getContext()));
        ...
        protected void onPostExecute(String s) {
            ...
            try{Gson gson = new Gson();
                ...
                if(response==Constants.NEW_ENTRY)
                {
                    ...
                    databaseAccess.UpdateFrndsProfile(mAddress,mState,mDist,mCity,mPin,mMobile,"Self",SharedPreferencesHelper.getUserEmail(getContext()),f_id);
